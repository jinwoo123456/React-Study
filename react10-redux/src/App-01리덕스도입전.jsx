...
/*
Rigth의 최하위 컴포넌트에서는 Click 이벤트를 통해 부모쪽에서 전달된
함수를 호출한다. 그러면 Right3 > Rigth2 > .. > App과 같은 순서대로
호출된다.
*/
const Right3 = (props) => {
  return (
...
//Left 최하위 컴포넌트에서는 Props로 전달받은 값을 출력한다.
const Left3 = (props) => {
  return (
    <div>
    ...
    <>
      <div className="root">
        ...
        <div id="grid">
          ...
          {/* Rigth 컴포넌트 하위로는 Sate를 변경하기 위한 Setter를 전달
          number에 1을 더하는 기능 */}
          <Right1
            onMyPlus1={() => {
              setNumber(number + 1);
